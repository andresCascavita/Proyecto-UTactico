<%-- 
    ...
    Created on : 31/05/2023, 03:02:01 PM
...
<html>
    <head>
        ...
        <title>BorrarReporte</title>
    </head>
    <body>
        <form  action="./BorrarReporteServlet" method="POST">
            ...
            <tr>
                ...
                <td><input type="number" name="id" value="${reporteincidente.id}" /></td>
            </tr>
