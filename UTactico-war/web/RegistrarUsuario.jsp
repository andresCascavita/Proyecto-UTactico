<%-- 
    ...
    Created on : 31/05/2023, 12:44:32 PM
            ...
            <table style="margin: 0 auto;">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <p> Ya tengo cuenta <a href="http://localhost:8080/UTactico-war/LoginUsuario.html"><input type="button" value="Iniciar sesion" style="background-color: aquamarine ;border-radius: 42%"></a></p>
                    </td>
                </tr>
            </table>
        </form>
